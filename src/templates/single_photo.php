            ...
            '<div class="container">
                <div class="photo_container">
                    <div class="carousel-caption">
                        ...
                        <div><a id="browse" class="btn btn-large btn-primary" href="gallery?galleryId=' . $galleryId . '">Browse gallery</a></div>
                    </div>
                    </div>
                </div>
            </div>
            ...
            <div class="md-header btn-toolbar">
                ...
                <div class="btn-group">
                    <button class="btn btn-default btn-sm" title="List" tabindex="-1" data-provider="bootstrap-markdown" data-handler="bootstrap-markdown-cmdList">
                        <span class="glyphicon glyphicon-list"></span> </button></div><div class="btn-group"><button class="btn btn-primary btn-sm btn-default btn-sm" title="Preview" tabindex="-1" data-provider="bootstrap-markdown" data-handler="bootstrap-markdown-cmdPreview" data-toggle="button">
                        <span class="glyphicon glyphicon-search"></span> Preview</button></div>
            </div><textarea id="textArea" name="content" data-provide="markdown" rows="15" class="md-input" style="resize: none;">### Hello there 
